...
makeCacheMatrix <- function(x = matrix()) {
  ...
  setinvMatx <- function(invM){
    invMatx <<- invM ##assign the inverse matrix to the environment var
  } 
  
  ##define the function for returning the inverse matrix
  getinvMatx <- function(){
    invMatx ##the environment var inverse matrix is return
  }
...
cacheSolve <- function(x, ...) {
  ...
  if (!is.null(invM)){
    ## check if the return invMatx is identical
